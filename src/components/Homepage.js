      ...
      <div className="add-todo w-4/5 md:w-1/2 mx-auto bg-gray-300 p-5 rounded-lg mt-[-50px]">
        <form onSubmit={handleAddTodo}>
          ...
          <div className="inline-flex rounded-md shadow-sm w-full" role="group">
            <input
              className="py-2 px-4 text-sm font-medium w-full text-gray-900 bg-transparent rounded-l-lg border border-gray-900 focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white dark:border-white dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:bg-gray-700"
              type="text"
              name="todo"
              id="todo"
